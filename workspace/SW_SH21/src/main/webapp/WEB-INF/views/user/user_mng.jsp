       ...
       // 삭제 
        ...
        $("#user_table > tbody").on("click", "tr", function(e){
           ...
           EClass.callAjax(url, parameters, method, async, function(data){
              ...
              console.log("data.regDt : "+ data.regDt);
        ...
        <form action="" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-md-10 col-lg-10">
              ...
              <input type="button" value="중복확인" class="btn btn-primary btn-sm form-control" id="idCheck" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 col-md-10 col-lg-10">
              <input type="text" maxlength="8" numberOnly name="login" id="login" placeholder="로그인" class="numberOnly form-control">
            </div>
          </div>           
